...
<div className="p-8 max-w-[1600px] mx-auto space-y-8">
      ...
      <button className="px-4 py-2 bg-surface-container-high rounded-lg text-xs font-bold text-[#A0A0C0] hover:text-white transition-all">Categories</button>
      <button className="px-4 py-2 bg-surface-container-high rounded-lg text-xs font-bold text-[#A0A0C0] hover:text-white transition-all">Payout Range</button>
      </div>
      </div>
      ...
      <span className="material-symbols-outlined">monitoring</span></button>
      </td>
      </tr>
      <tr className="group hover:bg-surface-container-high/40 transition-all">
      <td className="py-5">
