...
<div>
<h2 className="text-3xl font-black text-white font-headline tracking-tight">System Overview</h2>
<p className="text-[#A0A0C0] mt-1 font-medium">Real-time platform performance and vital signs.</p>
</div>
...
<span className="text-[10px] font-black text-tertiary bg-tertiary/20 px-2 py-0.5 rounded-full">+12%</span>
</div>
<p className="text-xs font-bold text-[#A0A0C0] uppercase tracking-widest font-headline">Revenue Today</p>
<p className="text-2xl font-black text-white font-mono mt-1">$4,320.00</p>
</div>
{/*  Active Users  */}
<div className="bg-surface-container-low p-5 rounded-xl border border-outline-variant/10">
<div className="flex justify-between items-start mb-4">
...
<span className="text-[10px] font-black text-secondary bg-secondary/10 px-2 py-0.5 rounded-full">↑ 234</span>
</div>
<p className="text-xs font-bold text-[#A0A0C0] uppercase tracking-widest font-headline">Active Users</p>
<p className="text-2xl font-black text-white font-mono mt-1">1,842</p>
</div>
{/*  Quizzes Played  */}
<div className="bg-surface-container-low p-5 rounded-xl border border-outline-variant/10">
<div className="flex justify-between items-start mb-4">
...
<p className="text-xs font-bold text-[#A0A0C0] uppercase tracking-widest font-headline">Quizzes Played</p>
<p className="text-2xl font-black text-white font-mono mt-1">8,470</p>
</div>
{/*  Pending Withdrawals  */}
<div className="bg-surface-container-low p-5 rounded-xl border border-outline-variant/10">
<div className="flex justify-between items-start mb-4">
<div className="p-2 bg-error-container/10 rounded-lg">
<span className="material-symbols-outlined text-error" style={{fontVariationSettings: ''FILL' 1'}}>outbox</span>
</div>
<span className="text-[10px] font-black text-white bg-error-container px-2 py-0.5 rounded-full">23</span>
</div>
<p className="text-xs font-bold text-[#A0A0C0] uppercase tracking-widest font-headline">Pending Payouts</p>
<p className="text-2xl font-black text-error font-mono mt-1">$4,200</p>
</div>
{/*  New Registrations  */}
<div className="bg-surface-container-low p-5 rounded-xl border border-outline-variant/10">
<div className="flex justify-between items-start mb-4">
...
<p className="text-xs font-bold text-[#A0A0C0] uppercase tracking-widest font-headline">New Reg.</p>
...
<p className="text-xs font-bold text-[#A0A0C0] uppercase tracking-widest font-headline">System Total</p>
<p className="text-2xl font-black text-secondary font-mono mt-1">$124.5k</p>
</div>
</div>
...
<div>
<h3 className="text-xl font-black text-white font-headline uppercase tracking-tight">Revenue Dynamics</h3>
<p className="text-[#A0A0C0] text-sm">30-day comparative analysis: Revenue vs Payouts</p>
</div>
<div className="flex gap-6">
<div className="flex items-center gap-2">
<span className="w-3 h-3 rounded-full bg-primary-container"></span>
<span className="text-xs font-bold text-on-surface uppercase tracking-wider">Gross Revenue</span>
</div>
<div className="flex items-center gap-2">
<span className="w-3 h-3 rounded-full bg-tertiary"></span>
<span className="text-xs font-bold text-on-surface uppercase tracking-wider">Prizes Paid</span>
</div>
</div>
</div>
...
<span className="text-[10px] font-bold text-[#484456] font-mono">01 OCT</span>
<span className="text-[10px] font-bold text-[#484456] font-mono">10 OCT</span>
<span className="text-[10px] font-bold text-[#484456] font-mono">20 OCT</span>
<span className="text-[10px] font-bold text-[#484456] font-mono">30 OCT</span>
</div>
</div>
...
<p className="text-[10px] font-black text-[#A0A0C0] uppercase tracking-widest">Gross Profit</p>
<p className="text-2xl font-black text-white font-mono mt-1">$124.5k</p>
</div>
<div className="p-6 bg-surface-container-high rounded-xl border-l-4 border-tertiary">
<p className="text-[10px] font-black text-[#A0A0C0] uppercase tracking-widest">Paid Out</p>
<p className="text-2xl font-black text-white font-mono mt-1">$89.2k</p>
</div>
<div className="p-6 bg-surface-container-high rounded-xl border-l-4 border-secondary">
<p className="text-[10px] font-black text-[#A0A0C0] uppercase tracking-widest">Net Margin</p>
<p className="text-2xl font-black text-secondary font-mono mt-1">28.3%</p>
...
<h3 className="text-xl font-black text-white font-headline uppercase tracking-tight">Platform Activity</h3>
...
<button className="text-sm font-bold text-primary hover:underline transition-all">View All</a>
</div>
...
<img className="w-full h-full object-cover" data-alt="close up avatar of a young smiling man" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBeF3az67MwqQXPcJZkrOpx1bjb2AHwwk4Fgwq2428thHaSwfVssZ8CcPi-hy1Z9pOtxBytcKcROaShDiObuvOgSZguBKN0lG7Hr-K0b1IUE8rSTZRgDhy6cEQQuRd1WlewhCZ6sK3s-LkEnwWf1thrAMb9vjX36-czv9O0zgQkdmbZYkthF9vb2qcotIcd_RqBat25t1pfAq5ifkQmM0RyCGnSTEWatzyLiRArjMFs53v6_xoDVPKN6tgln1TbNCFy1jMkgzmPPQ"/>
</div>
<div>
<p className="text-sm font-bold text-white"><span className="text-primary">@cryptoking</span> won <span className="text-tertiary">$250.00</span> in Daily Blitz</p>
<p className="text-[10px] text-[#A0A0C0] font-medium">Just now</p>
</div>
</div>
...
<div>
<p className="text-sm font-bold text-white"><span className="text-primary">@sarah_q</span> deposited <span className="text-white">$1,000.00</span></p>
<p className="text-[10px] text-[#A0A0C0] font-medium">2 minutes ago</p>
</div>
</div>
<span className="text-[10px] font-black text-secondary-container font-mono tracking-tighter">SUCCESS</span>
</div>
{/*  Feed Item: Withdrawal  */}
<div className="flex items-center justify-between p-4 bg-surface-container-high/40 rounded-xl hover:bg-surface-container-high transition-all">
<div className="flex items-center gap-4">
<div className="w-10 h-10 rounded-full overflow-hidden">
<img className="w-full h-full object-cover" data-alt="profile photo of a woman with red hair looking into camera" src="https://lh3.googleusercontent.com/aida-public/AB6AXuD7Spbsyty0I-hz7WUh9wdA4NUSiLBTIEQ0l8doNUfdGFYX2qvUSKaZAMokbdDUjYobqIKQC06kh2yvkLcOwiHk-Te2e21UfrltPjrBaUYZTpvkbBuMZZS7f0JxNkPdV24aiXgd4f7Ga0yvN7Q5RyJdyyxzxAot4khlLvDDDu1CIorMvP7GDnKbVG0p5jEXFEsuo2Tnm10yRru_zMBS036yuxU5tdvqPuWErXa2QuZNoEWGkkcxB5zr_K4TJspLmbHpstdGkHiicQ"/>
</div>
<div>
<p className="text-sm font-bold text-white"><span className="text-primary">@fox_hound</span> requested withdrawal <span className="text-white">$450.00</span></p>
<p className="text-[10px] text-[#A0A0C0] font-medium">5 minutes ago</p>
</div>
</div>
...
<div>
<p className="text-sm font-bold text-white">New user <span className="text-primary">@marco_polo</span> joined the arena</p>
<p className="text-[10px] text-[#A0A0C0] font-medium">12 minutes ago</p>
</div>
</div>
...
<h3 className="text-xl font-black text-white font-headline uppercase tracking-tight mb-6">Action Required</h3>
<div className="space-y-4">
...
<div className="flex-1">
<p className="text-sm font-black text-white uppercase tracking-tight">23 Withdrawals</p>
<p className="text-xs text-error font-bold font-mono">$4,200 Total</p>
</div>
...
<div className="flex-1">
<p className="text-sm font-black text-white uppercase tracking-tight">8 KYC Pending</p>
<p className="text-xs text-[#A0A0C0] font-medium">Verification queue</p>
</div>
<span className="material-symbols-outlined text-on-surface-variant">chevron_right</span>
</div>
...
<div className="flex-1">
<p className="text-sm font-black text-white uppercase tracking-tight">5 Support Tickets</p>
<p className="text-xs text-[#A0A0C0] font-medium">3 Critical issues</p>
</div>
<span className="material-symbols-outlined text-on-surface-variant">chevron_right</span>
</div>
<div className="p-4 bg-surface-container-high rounded-xl border border-outline-variant/10 flex items-center gap-4 group cursor-pointer hover:bg-surface-bright transition-all">
...
<div className="flex-1">
<p className="text-sm font-black text-white uppercase tracking-tight">2 User Reports</p>
<p className="text-xs text-[#A0A0C0] font-medium">Possible cheating</p>
</div>
<span className="material-symbols-outlined text-on-surface-variant">chevron_right</span>
</div>
</div>
...
<h3 className="text-xl font-black text-white font-headline uppercase tracking-tight">Today's Top Performers</h3>
<div className="flex gap-2">
<button className="px-4 py-2 bg-surface-container-high rounded-lg text-xs font-bold text-[#A0A0C0] hover:text-white transition-all">Categories</a>
<button className="px-4 py-2 bg-surface-container-high rounded-lg text-xs font-bold text-[#A0A0C0] hover:text-white transition-all">Payout Range</a>
</div>
</div>
...
<span className="text-sm font-bold text-white">Daily Crypto Blitz</span>
</div>
</td>
<td className="py-5 text-sm text-[#A0A0C0] font-medium">Finance</td>
<td className="py-5 text-sm font-mono text-white">2,410</td>
<td className="py-5 text-sm font-mono text-white">$1,205.00</td>
<td className="py-5 text-sm font-mono text-tertiary">$840.00</td>
<td className="py-5 text-sm font-mono text-secondary">+$365.00</td>
...
<span className="text-sm font-bold text-white">World Cup Trivia</span>
</div>
</td>
<td className="py-5 text-sm text-[#A0A0C0] font-medium">Sports</td>
<td className="py-5 text-sm font-mono text-white">1,890</td>
<td className="py-5 text-sm font-mono text-white">$945.00</td>
<td className="py-5 text-sm font-mono text-tertiary">$600.00</td>
<td className="py-5 text-sm font-mono text-secondary">+$345.00</td>
<td className="py-5 text-right">
<button className="p-2 hover:bg-primary-container/20 rounded-lg text-primary transition-all">
<span className="material-symbols-outlined">monitoring</span>
</a>
...
<span className="text-sm font-bold text-white">Sci-Fi Blockbusters</span>
</div>
</td>
<td className="py-5 text-sm text-[#A0A0C0] font-medium">Entertainment</td>
<td className="py-5 text-sm font-mono text-white">1,240</td>
<td className="py-5 text-sm font-mono text-white">$620.00</td>
<td className="py-5 text-sm font-mono text-tertiary">$450.00</td>
<td className="py-5 text-sm font-mono text-secondary">+$170.00</td>
<td className="py-5 text-right">
<button className="p-2 hover:bg-primary-container/20 rounded-lg text-primary transition-all">
<span className="material-symbols-outlined">monitoring</span>
</a>
...
<span className="text-sm font-bold text-white">AI Frontiers Quiz</span>
</div>
</td>
<td className="py-5 text-sm text-[#A0A0C0] font-medium">Technology</td>
<td className="py-5 text-sm font-mono text-white">980</td>
<td className="py-5 text-sm font-mono text-white">$490.00</td>
<td className="py-5 text-sm font-mono text-tertiary">$320.00</td>
<td className="py-5 text-sm font-mono text-secondary">+$170.00</td>
<td className="py-5 text-right">
<button className="p-2 hover:bg-primary-container/20 rounded-lg text-primary transition-all">
<span className="material-symbols-outlined">monitoring</span>
