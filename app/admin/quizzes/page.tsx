...
<button className="pb-4 text-sm font-bold text-primary-container border-b-2 border-primary-container transition-all">Daily</a>
<button className="pb-4 text-sm font-medium text-outline hover:text-on-surface transition-all">Weekly</a>
<button className="pb-4 text-sm font-medium text-outline hover:text-on-surface transition-all">Challenges</a>
<button className="pb-4 text-sm font-medium text-outline hover:text-on-surface transition-all">All Quizzes</a>
</div>
...
<button className="material-symbols-outlined text-outline hover:text-on-surface">more_vert</a>
</td>
</tr>
<tr className="hover:bg-surface-container-low/40 transition-colors">
<td className="px-6 py-4">
