...
<button className="w-full mt-6 py-2 rounded-lg border border-outline-variant/30 text-xs font-bold text-on-surface hover:bg-surface-container-high transition-all">Edit Rules</a>
</div>
...
<span className="absolute right-1 top-1 w-2.5 h-2.5 bg-secondary rounded-full"></span>
</a>
</div>
</div>
</div>
...
<button className="px-8 py-3 rounded-xl bg-surface-container-high text-on-surface font-bold hover:bg-surface-bright transition-all">Discard Changes</a>
<button className="px-8 py-3 rounded-xl bg-gradient-to-r from-primary-container to-primary text-white font-bold shadow-[0_4px_20px_rgba(108,62,255,0.4)] hover:scale-105 transition-all">Save All Settings</a>
</div>
</div>
</div>
