...
{/*  TopNavBar  */}
      ...
      <span className="material-symbols-outlined text-sm" data-icon="download">download</span> Export CSV</button>
      ...
      <span className="material-symbols-outlined text-sm" data-icon="add">add</span> Create User</button>
      </div>
      </div>
      {/*  Filter Bar  */}
      ...
      <span className="material-symbols-outlined" data-icon="filter_list">filter_list</span></button>
      </div>
      </div>
      {/*  Users Table  */}
      ...
      <span className="material-symbols-outlined" data-icon="visibility">visibility</span></button>
      </td>
      </tr>
      {/*  Standard Row  */}
      ...
      <span className="material-symbols-outlined" data-icon="more_vert">more_vert</span></button>
      </td>
      </tr>
      {/*  Standard Row  */}
      <tr className="border-b border-outline-variant/5 hover:bg-surface-container transition-colors group">
      ...
      <td className="px-6 py-4 text-right">
      <button className="p-2 hover:bg-surface-bright rounded-lg text-outline"><span className="material-symbols-outlined" data-icon="more_vert">more_vert</span></button>
      </td>
      </tr>
      </tbody>
      </table>
      ...
      <button className="px-3 py-1 rounded border border-outline-variant/20 hover:bg-surface-bright transition-colors">Prev</button>
      <button className="px-3 py-1 rounded bg-primary text-on-primary-fixed font-bold">1</button>
      <button className="px-3 py-1 rounded hover:bg-surface-bright transition-colors">2</button>
      <button className="px-3 py-1 rounded hover:bg-surface-bright transition-colors">3</button>
      <button className="px-3 py-1 rounded border border-outline-variant/20 hover:bg-surface-bright transition-colors">Next</button>
      </div>
      </div>
      </div>
      </section>
