...
<button className="flex-1 py-2 text-xs font-bold font-headline bg-[#6C3EFF] text-white rounded-lg">Active</a>
<button className="flex-1 py-2 text-xs font-bold font-headline text-[#A0A0C0] hover:text-white">Suspended</a>
<button className="flex-1 py-2 text-xs font-bold font-headline text-[#A0A0C0] hover:text-white">Banned</a>
</div>
...
<button className="p-2 hover:bg-[#6C3EFF]/20 rounded-lg text-[#6C3EFF]"><span className="material-symbols-outlined text-sm">visibility</span></a>
<button className="p-2 hover:bg-red-500/20 rounded-lg text-red-500"><span className="material-symbols-outlined text-sm">block</span></a>
</div>
</td>
</tr>
{/*  Row 2  */}
...
<button className="w-10 h-10 flex items-center justify-center rounded-lg border border-[#484456]/20 text-[#A0A0C0] hover:bg-[#292934] transition-all"><span className="material-symbols-outlined">chevron_left</span></a>
<button className="w-10 h-10 flex items-center justify-center rounded-lg bg-[#6C3EFF] text-white font-bold shadow-lg">1</a>
<button className="w-10 h-10 flex items-center justify-center rounded-lg border border-[#484456]/20 text-[#A0A0C0] hover:bg-[#292934] transition-all">2</a>
<button className="w-10 h-10 flex items-center justify-center rounded-lg border border-[#484456]/20 text-[#A0A0C0] hover:bg-[#292934] transition-all">3</a>
<button className="w-10 h-10 flex items-center justify-center rounded-lg border border-[#484456]/20 text-[#A0A0C0] hover:bg-[#292934] transition-all">...</a>
<button className="w-10 h-10 flex items-center justify-center rounded-lg border border-[#484456]/20 text-[#A0A0C0] hover:bg-[#292934] transition-all"><span className="material-symbols-outlined">chevron_right</span></a>
</div>
</div>
