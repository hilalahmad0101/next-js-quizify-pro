...
<button className="w-10 h-10 rounded-lg bg-primary-container text-white font-bold text-sm">1</a>
<button className="w-10 h-10 rounded-lg border border-outline-variant/20 flex items-center justify-center text-outline hover:bg-surface-container transition-all text-sm font-bold">2</a>
<button className="w-10 h-10 rounded-lg border border-outline-variant/20 flex items-center justify-center text-outline hover:bg-surface-container transition-all text-sm font-bold">3</a>
<button className="w-10 h-10 rounded-lg border border-outline-variant/20 flex items-center justify-center text-outline hover:bg-surface-container transition-all">
