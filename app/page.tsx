  ...
  return (
    <>
      <div className="selection:bg-primary-container selection:text-white">
        <nav className="fixed top-0 w-full z-50 bg-[#0A0A14]/80 backdrop-blur-xl border-b border-primary-container/10">
          <div className="max-w-7xl mx-auto flex justify-between items-center px-8 h-20">
            <div className="flex items-center gap-2">
              <span
                className="material-symbols-outlined text-[#6C3EFF] text-3xl"
                style={{ fontVariationSettings: "'FILL' 1" }}
              >
                bolt
              </span>
              <span className="text-2xl font-bold text-[#6C3EFF] tracking-tight font-headline">
                QuizifyPro
              </span>
            </div>
            <div className="hidden md:flex items-center gap-8 font-headline text-[#A0A0C0]">
              <a
                className="text-[#6C3EFF] font-bold hover:text-white transition-all duration-300"
                href="#"
              >
                How it Works
              </a>
            ...
            <div className="flex items-center gap-4">
              <a
                className="px-6 py-2 text-[#A0A0C0] font-medium hover:text-white transition-colors"
                href="/login"
              >
                Login
              </a>
              <a
                className="px-6 py-2.5 bg-primary-container text-white rounded-lg font-bold shadow-lg shadow-primary-container/20 hover:scale-105 active:scale-95 transition-all text-center"
                href="/register"
              >
                Get Started
              </a>
          ...
          <div className="max-w-7xl mx-auto px-8 w-full grid md:grid-cols-2 gap-12 items-center relative z-10">
            <div className="space-y-8">
              ...
              <h1 className="text-6xl md:text-7xl font-bold font-headline leading-[1.1] tracking-tight text-white">
                Play Quizzes.
                <br />
                <span className="gradient-text bg-gradient-to-r from-primary-fixed-dim to-tertiary">
                  Win Real Money.
                </span>
              </h1>
              <p className="text-xl text-on-surface-variant max-w-lg leading-relaxed">
                Join over 50k+ players competing in real-time knowledge arenas.
                Turn your expertise into earnings today.
              </p>
              <div className="flex flex-wrap gap-4">
                <a
                  className="px-8 py-4 bg-primary-container text-white rounded-xl font-bold flex items-center gap-2 shadow-2xl shadow-primary-container/40 hover:brightness-110 transition-all group"
            ...
            <div className="relative flex justify-center items-center">
              <div className="relative w-[320px] h-[640px] bg-surface-container-lowest rounded-[3rem] border-8 border-surface-bright shadow-2xl overflow-hidden p-4">
                ...
                <div className="h-full flex flex-col pt-8 space-y-4">
                  ...
                  <h4 className="text-lg font-bold text-white pt-4">
                    Which planet has the strongest winds in our solar system?
                  </h4>
                  <div className="space-y-3 pt-4">
                    <div className="p-4 bg-surface-container-high border border-outline-variant/20 rounded-xl text-sm text-white">
                      Jupiter
                    </div>
                    <div className="p-4 bg-primary-container border border-primary text-sm text-white font-bold">
                      Neptune
                    </div>
                    <div className="p-4 bg-surface-container-high border border-outline-variant/20 rounded-xl text-sm text-white">
                      Saturn
        ...
        <section className="py-24 max-w-7xl mx-auto px-8">
          <div className="text-center mb-16 space-y-4">
            <h2 className="text-4xl font-headline font-bold text-white">
              Master the Arena in{" "}
              <span className="text-primary-fixed-dim">3 Steps</span>
            </h2>
            <p className="text-on-surface-variant">
              The path from curiosity to professional earner is simpler than you
              think.
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-8 relative">
            ...
            <div className="relative p-8 rounded-2xl bg-surface-container-low border border-outline-variant/10 hover:border-primary-container/30 transition-all">
              ...
              <p className="text-on-surface-variant leading-relaxed">
                Securely fund your wallet with as little as $2 using encrypted
                gateways.
              </p>
              <span className="absolute top-4 right-8 text-6xl font-headline font-black text-white/5">
                01
              </span>
            </div>
            {/*  Step 2  */}
            <div className="relative p-8 rounded-2xl bg-surface-container-low border border-outline-variant/10 hover:border-primary-container/30 transition-all">
              ...
              <p className="text-on-surface-variant leading-relaxed">
                Select your expertise and enter high-stakes live tournament
                lobbies.
              </p>
              <span className="absolute top-4 right-8 text-6xl font-headline font-black text-white/5">
                02
            ...
            <div className="relative p-8 rounded-2xl bg-surface-container-low border border-outline-variant/10 hover:border-primary-container/30 transition-all">
              ...
              <p className="text-on-surface-variant leading-relaxed">
                Climb the leaderboard and cash out your winnings instantly to
                your bank.
              </p>
              <span className="absolute top-4 right-8 text-6xl font-headline font-black text-white/5">
                03
        ...
        <section className="py-24 bg-surface-container-lowest/50">
          <div className="max-w-7xl mx-auto px-8">
            <div className="flex justify-between items-end mb-12">
              <div>
                <h2 className="text-4xl font-headline font-bold text-white mb-2">
                  Explore Domains
                </h2>
                <p className="text-on-surface-variant">
                  Choose your battlefield. Over 500+ daily quizzes active.
                </p>
              </div>
        ...
        {/*  Live Prizes  */}
        <section className="py-24 max-w-7xl mx-auto px-8">
          <h2 className="text-4xl font-headline font-bold text-white mb-16 text-center">
            Featured <span className="text-tertiary">Jackpots</span>
          </h2>
          <div className="grid md:grid-cols-3 gap-8 items-center">
            ...
            <div className="p-8 rounded-3xl bg-surface-container-low border border-outline-variant/20 flex flex-col items-center text-center space-y-6">
              <div className="text-tertiary font-mono uppercase tracking-[0.2em] text-sm">
                Daily Arena
              </div>
              <div className="text-5xl font-headline font-black text-white">
                $500
              </div>
              ...
              <button className="w-full py-4 rounded-xl border border-outline-variant/30 text-white font-bold hover:bg-surface-container-high transition-all">
                Register Now
              </button>
            </div>
            {/*  Weekly Featured  */}
            <div className="p-10 rounded-[2.5rem] bg-gradient-to-b from-primary-container/20 to-surface-container-high border-2 border-primary-container shadow-2xl shadow-primary-container/20 flex flex-col items-center text-center space-y-8 relative overflow-hidden scale-110 z-10">
              <div className="absolute top-0 right-0 p-4 bg-primary-container text-white text-xs font-bold font-headline uppercase tracking-tighter rounded-bl-2xl">
                High Stakes
              </div>
              <div className="text-primary-fixed-dim font-mono uppercase tracking-[0.2em] text-sm">
                Weekly Championship
              </div>
              <div className="text-7xl font-headline font-black text-white">
                $5,000
              </div>
              <div className="space-y-2">
                <div className="text-xs font-mono text-on-surface-variant">
                ...
                <div className="text-2xl font-mono font-bold text-primary-fixed-dim">
                  12h 08m 44s
                </div>
              </div>
              ...
              <button className="w-full py-5 rounded-2xl bg-primary-container text-white font-bold text-lg shadow-xl shadow-primary-container/30 hover:scale-[1.02] transition-all">
                Join The Arena
              </button>
            </div>
            {/*  Custom Challenge  */}
            <div className="p-8 rounded-3xl bg-surface-container-low border border-outline-variant/20 flex flex-col items-center text-center space-y-6">
              <div className="text-secondary-fixed font-mono uppercase tracking-[0.2em] text-sm">
                Challenge Mode
              </div>
              <div className="text-5xl font-headline font-black text-white">
                Custom
        ...
        <section className="py-24 bg-surface-container-lowest">
          <div className="max-w-4xl mx-auto px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-on-surface-variant font-mono mt-2">
                REAL-TIME RANKINGS • LAST 24 HOURS
              </p>
            </div>
            <div className="bg-surface-container-low rounded-3xl border border-outline-variant/10 overflow-hidden">
              ...
              <div className="divide-y divide-outline-variant/5">
                ...
                <div className="p-5 grid grid-cols-12 items-center bg-primary-container/5">
                  <div className="col-span-2 px-4">
                    <span className="w-8 h-8 rounded-lg bg-tertiary flex items-center justify-center text-on-tertiary font-bold">
                      1
                    </span>
                  </div>
                  <div className="col-span-6 flex items-center gap-3">
                    <div className="w-10 h-10 rounded-full bg-surface-container-highest flex items-center justify-center font-bold text-white border border-tertiary">
                      JD
                    </div>
                    <div className="font-bold text-white">@CipherMaster</div>
                  </div>
                  <div className="col-span-4 text-right px-4 font-mono font-bold text-tertiary">
                    $12,450.00
                  </div>
                </div>
                {/*  Top 2  */}
                <div className="p-5 grid grid-cols-12 items-center">
                  <div className="col-span-2 px-4">
                    <span className="w-8 h-8 rounded-lg bg-outline/20 flex items-center justify-center text-white font-bold">
                      2
                    </span>
                  </div>
                  <div className="col-span-6 flex items-center gap-3">
                    <div className="w-10 h-10 rounded-full bg-surface-container-highest flex items-center justify-center font-bold text-white">
                      AL
                    </div>
                    <div className="font-bold text-white">@AlexLogic</div>
                  </div>
                  <div className="col-span-4 text-right px-4 font-mono font-bold text-white">
                    $8,200.50
                  </div>
                </div>
                {/*  Top 3  */}
                <div className="p-5 grid grid-cols-12 items-center">
                  <div className="col-span-2 px-4">
                    <span className="w-8 h-8 rounded-lg bg-[#CD7F32]/20 flex items-center justify-center text-white font-bold">
                      3
                    </span>
                  </div>
                  <div className="col-span-6 flex items-center gap-3">
                ...
                <div className="p-4 grid grid-cols-12 items-center opacity-60">
                  ...
                  <div className="col-span-4 text-right px-4 font-mono">
                    $4,300.00
                  </div>
                </div>
              ...
              <div className="p-6 bg-surface-container-high/50 text-center">
                <button className="text-primary-fixed-dim font-bold">
        ...
        <section className="py-24 max-w-7xl mx-auto px-8">
          <h2 className="text-4xl font-headline font-bold text-white mb-16">
            Winner <span className="text-secondary-fixed">Confessions</span>
          </h2>
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="p-8 rounded-3xl bg-surface-container-low border border-outline-variant/10 relative overflow-hidden">
              ...
              <p className="text-lg text-white font-medium leading-relaxed italic">
                "I started with $10 thinking I'd just have some fun. Three weeks
                later, I've withdrawn over $2,400. The interface is surgical and
              ...
              <div className="mt-8 flex items-center justify-between">
                ...
                <div className="text-secondary-fixed font-mono font-bold">
                  +$2,450.00 Won
                </div>
              </div>
            </div>
            ...
            <div className="p-8 rounded-3xl bg-surface-container-low border border-outline-variant/10 relative overflow-hidden">
              ...
              <p className="text-lg text-white font-medium leading-relaxed italic">
                "Most trivia apps feel like games for kids. QuizifyPro feels
                like a high-stakes arena. It's intense, fair, and finally
              ...
              <div className="mt-8 flex items-center justify-between">
                <div className="flex items-center gap-4">
                  <img
                    className="w-12 h-12 rounded-full object-cover"
                    data-alt="vibrant professional woman smiling warmly with natural lighting and blurred urban greenery in background"
                    src="https://lh3.googleusercontent.com/aida-public/AB6AXuBpoth8HYRdKJt2B2PPJRc1w5N33tzEI-6Vtl5rM2Zk9e--QvpFLqpiM7gk3KfH2jLG2n_03EbnweM9IVYUndXE7lrl2MmSt_t6YNS7rbeywSg3sIDBT0jF9_h6FqajzBKBMxiSlRgaOdt4oMhpiuRPSvnqbi9je3Izt8ehoPPHT8i4UfcTYRjEKceCnZ5flLgV-da1pv-nBFBQGtpeL4BGvqDGyAvXCGL_lQkmQw66cYGhpesTAc71Yz6juqRqyKI7rNROEmbgTg"
                  />
                  <div>
        ...
        <section className="py-24 max-w-5xl mx-auto px-8">
          <h2 className="text-4xl font-headline font-bold text-white mb-12 text-center">
            Frequently Asked{" "}
            ...
            <div className="space-y-4">
              <div className="p-6 rounded-2xl bg-surface-container-high border-l-4 border-primary-container">
                ...
                <p className="text-sm text-on-surface-variant leading-relaxed">
                  Yes, all transactions are processed through AES-256 encrypted
                  gateways and stored in cold wallets for maximum protection.
                </p>
              </div>
        ...
        <section className="py-24 max-w-7xl mx-auto px-8">
          <div className="relative rounded-[3rem] bg-gradient-to-r from-primary-container to-[#4F29CC] p-12 md:p-20 overflow-hidden text-center">
            ...
            <div className="relative z-10 space-y-8">
              <h2 className="text-5xl md:text-6xl font-headline font-black text-white leading-tight">
                Ready to Win?
                <br />
                Start with just $2.
              </h2>
              <div className="flex flex-col md:flex-row gap-4 justify-center items-center">
                <a
                  className="px-10 py-5 bg-white text-primary-container rounded-2xl font-black text-xl hover:scale-105 active:scale-95 transition-all flex items-center gap-2 justify-center"
                  href="/register"
                >
                  Create Free Account
                ...
                <span className="text-on-primary-container font-mono text-sm">
                  NO CREDIT CARD REQUIRED FOR FREE TEIR
                </span>
              </div>
            </div>
          </div>
        ...
        <footer className="bg-[#0A0A14] pt-24 pb-12 px-8 border-t border-outline-variant/10">
          <div className="max-w-7xl mx-auto grid md:grid-cols-4 gap-12 mb-16">
            <div className="space-y-6">
              <div className="flex items-center gap-2">
                <span className="material-symbols-outlined text-[#6C3EFF] text-3xl">
                  bolt
                </span>
                <span className="text-2xl font-bold text-[#6C3EFF] tracking-tight font-headline">
                  QuizifyPro
              ...
              <p className="text-sm leading-relaxed max-w-xs">
                The Electric Alchemist's Arena. Where knowledge is converted
                into digital gold. Competitive quizzing redefined for the modern
                era.
              </p>
            ...
            <div>
              <h5 className="text-white font-bold font-headline mb-6">
                Platform
              </h5>
