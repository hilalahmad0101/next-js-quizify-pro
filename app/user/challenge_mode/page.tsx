...
{/*  Header Section  */}
      ...
      <button className="px-5 py-2 rounded-full border border-primary-container bg-primary-container text-white text-sm font-bold">10 Qs</button>
      <button className="px-5 py-2 rounded-full border border-outline-variant text-[#A0A0C0] text-sm hover:border-primary transition-colors">25 Qs</button>
      <button className="px-5 py-2 rounded-full border border-outline-variant text-[#A0A0C0] text-sm hover:border-primary transition-colors">50 Qs</button>
      </div>
      </div>
      <div>
      <label className="block text-xs font-headline font-bold text-[#A0A0C0] uppercase mb-3 tracking-widest">Time per Question</label>
      <div className="flex gap-3">
      <button className="px-5 py-2 rounded-full border border-outline-variant text-[#A0A0C0] text-sm hover:border-primary transition-colors">15s</button>
      <button className="px-5 py-2 rounded-full border border-primary-container bg-primary-container text-white text-sm font-bold">30s</button>
      <button className="px-5 py-2 rounded-full border border-outline-variant text-[#A0A0C0] text-sm hover:border-primary transition-colors">60s</button>
      </div>
      </div>
      </div>
      <div className="space-y-6">
