...
<span className="text-primary-fixed text-sm font-medium">Saturday, March 29, 2025</span>
</div>
<h1 className="text-4xl lg:text-6xl font-headline font-black text-white leading-tight mb-2">Daily Quiz Challenge</h1>
<p className="text-primary-fixed/80 text-lg">Master the universe of knowledge and claim your spot on the throne.</p>
</div>
<div className="relative z-10 flex flex-col items-center md:items-end text-center md:text-right">
<div className="mb-4">
<div className="text-sm font-headline uppercase tracking-[0.2em] text-primary-fixed/70">Total Prize Pool</div>
<div className="text-5xl lg:text-7xl font-mono font-bold text-tertiary drop-shadow-lg">$500</div>
</div>
<div className="bg-black/20 backdrop-blur-md rounded-2xl px-6 py-3 flex items-center gap-6 border border-white/10">
<div>
<div className="text-[10px] uppercase text-primary-fixed/60">Entry Fee</div>
<div className="text-xl font-mono text-white">$2</div>
</div>
<div className="h-8 w-[1px] bg-white/10"></div>
<div>
<div className="text-[10px] uppercase text-primary-fixed/60">Players Joined</div>
...
<span className="font-mono text-8xl font-black text-white">06:24:11</span>
</div>
