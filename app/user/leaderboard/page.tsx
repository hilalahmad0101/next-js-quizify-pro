...
{/*  Page Header & Tab Row  */}
      ...
      <button className="px-5 py-2 text-sm font-medium text-[#A0A0C0] hover:text-white transition-colors">Daily</button>
      <button className="px-5 py-2 text-sm font-bold text-white bg-surface-container-high rounded-lg shadow-sm">Weekly</button>
      <button className="px-5 py-2 text-sm font-medium text-[#A0A0C0] hover:text-white transition-colors">Monthly</button>
      <button className="px-5 py-2 text-sm font-medium text-[#A0A0C0] hover:text-white transition-colors">All Time</button>
      ...
      <span className="material-symbols-outlined text-xs" data-icon="keyboard_arrow_down">keyboard_arrow_down</span></button>
      </div>
      </div>
      {/*  Podium Section  */}
