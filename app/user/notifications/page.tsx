...
<button className="px-6 py-2.5 rounded-xl text-sm font-medium border border-outline-variant/20 hover:bg-surface-container transition-all">Mark all as read</a>
<button className="px-6 py-2.5 rounded-xl text-sm font-bold bg-gradient-to-r from-primary-container to-inverse-primary text-white shadow-lg shadow-primary/20 hover:scale-105 active:scale-95 transition-all">Clear History</a>
</div>
</div>
{/*  Filters Grid  */}
...
<button className="text-xs font-bold text-primary flex items-center gap-1 hover:underline">
                            View detailed stats <span className="material-symbols-outlined text-[16px]">arrow_forward</span>
</a>
</div>
</div>
</div>
...
<button className="text-xs font-bold text-outline hover:text-white flex items-center gap-1">
                            Download Receipt <span className="material-symbols-outlined text-[16px]">download</span>
</a>
</div>
</div>
</div>
