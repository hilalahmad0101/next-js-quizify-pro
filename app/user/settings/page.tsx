...
<div className="grid grid-cols-12 gap-10">
      ...
      <span className="material-symbols-outlined text-sm opacity-0 group-hover:opacity-100 transition-opacity" data-icon="chevron_right">chevron_right</span></button>
      ...
      <button className="bg-primary-container hover:bg-primary text-white px-6 py-3 rounded-xl font-medium transition-all active:scale-95">Update</button>
      </div>
      </div>
      </div>
      </div>
      ...
      <button className="text-xs font-bold text-error uppercase tracking-widest hover:underline">Disconnect</button>
      </div>
      ...
      <button className="text-xs font-bold text-primary uppercase tracking-widest hover:text-white transition-colors">Connect</button>
      </div>
      </div>
      </div>
      {/*  Danger Zone  */}
      ...
      <button className="bg-error hover:bg-red-500 text-on-error font-bold px-6 py-3 rounded-xl transition-all hover:shadow-[0_0_20px_rgba(255,180,171,0.3)]">Delete Account</button>
      </div>
      </div>
</>
    )
