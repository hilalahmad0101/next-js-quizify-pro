...
<div className="max-w-6xl mx-auto space-y-8">
      ...
      <button className="w-full border border-primary/40 text-primary py-3 rounded-xl font-bold text-xs uppercase tracking-widest hover:bg-primary hover:text-white transition-all">Learn More</button>
      </div>
      {/*  Support Widget  */}
      ...
      <button className="w-full bg-surface-container-high text-white py-3 rounded-xl text-sm font-semibold hover:bg-surface-container-highest transition-colors">Start Chat</button>
      </div>
      </div>
      </div>
      </div>
